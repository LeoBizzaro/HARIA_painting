...
Z_ACTIVE_THICK_BASE = 0.113   # Base height for thick pencils (ends with 'b')
Z_ACTIVE_TIGHT_BASE = 0.130   # Base height for tight pencils (ends with 's')
