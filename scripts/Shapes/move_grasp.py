...
class PencilPickupNode:
    def __init__(self):
        ...
        # Gripper action clients - Using both Move and Grasp
        ...
        print("Connected to gripper action servers")
    ...
    def open_gripper(self):
        ...
        print("Opening gripper with MoveAction")
    ...
    def execute_pickup_and_circle(self):
        try:
            ...
            # Wait for user input
            input("Press Enter to close gripper and grasp pencil...")
           
            # Close gripper with force control using GraspAction
            self.close_gripper()
            ...
            # Open gripper to release pencil using MoveAction
            self.open_gripper()
